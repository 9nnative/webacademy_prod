 ...
 */
final class Version20220516113838 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE feed_event DROP likes');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE feed_event ADD likes INT NOT NULL');
