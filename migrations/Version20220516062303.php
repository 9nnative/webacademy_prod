 ...
 */
final class Version20220516062303 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE course ADD targets LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\'');
    }
